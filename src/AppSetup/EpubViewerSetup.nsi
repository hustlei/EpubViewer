...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC0} "EpubViewer程序"
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC1} "关联.epub,.epub3文件"
...
Function shownet
  ...
  ${If} $R1 < '4.0.30319'
    ...
    MessageBox MB_ICONINFORMATION|MB_OK "运行本软件需要Microsoft .Net Framework4.0或以上版本， \
		$\r$\n 您电脑上的.Net Framework版本较低，请自行下载安装4.0版本 \
		$\r$\n 微软官方下载地址为：\
